...
| 15 | [15-risk-aware-routing.md](15-risk-aware-routing.md) | **Phase 11 build (Upgrade 3, ✅ built):** price doors `mean − κ·std` over the bootstrap ensemble (optional CVaR); `κ=0` is an exact no-op. §6 documents the as-built code. |
